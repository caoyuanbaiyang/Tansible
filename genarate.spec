...
a = Analysis(['E:\\PyCharmProject\\Tansible\\main.py'],
             ...
             binaries=[],
             datas=[],
             hiddenimports=['model.CheckHostname.CheckHostname', 'model.DbPwdModify.DbPwdModify', 'model.DbPwdModifys.DbPwdModifys', 'model.Tsftp.Tsftp', 'model.Tshell.Tshell', 'model.Tupload.Tupload', 'model.Tvsget.Tvsget', 'model.Tvsget1.Tvsget1', 'model.SysPwdModify.SysPwdModify'],
             hookspath=[],
             runtime_hooks=[],
             excludes=[],
